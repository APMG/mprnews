...
const IconUpdraft = (props) => {
  ...
  return (
    ...
    >
      <path
        className="icon-updraft_outline"
        d="M3,15.65c0,0.08,0.06,0.12,0.17,0.12H4.6c0.07,0,0.13-0.05,0.2-0.14c0.22-0.54,0.57-0.99,1.05-1.35
	...
	C3.01,15.59,3,15.62,3,15.65z"
      />
      <path
        className="icon-updraft_sun"
        d="M16.5,9.03c0.72-0.68,1.54-1.02,2.48-1.02c0.97,0,1.8,0.35,2.51,1.05
	c0.7,0.7,1.05,1.54,1.05,2.51c0,0.65-0.17,1.26-0.52,1.83c-0.96-0.96-2.11-1.43-3.46-1.43h-0.34C17.99,10.88,17.41,9.9,16.5,9.03z"
      />
      <path
        className="icon-updraft_wind"
        d="M0.35,18c0,0.22,0.09,0.41,0.27,0.57
	...
	C0.43,17.57,0.35,17.77,0.35,18z"
      />
      <path
        className="icon-updraft_wind"
	...
	c-0.52-0.53-1.15-0.79-1.88-0.79H1.23c-0.24,0-0.44,0.09-0.62,0.26S0.35,20.78,0.35,21.01z"
      />
      <path
        className="icon-updraft_ray"
        d="M11.18,4.62c0,0.23,0.09,0.43,0.27,0.6l0.61,0.65c0.16,0.16,0.37,0.24,0.61,0.24
	...
	s-0.44,0.08-0.61,0.25C11.26,4.19,11.18,4.39,11.18,4.62z"
      />
      <path
        className="icon-updraft_ray"
        d="M18.12,3.79c0,0.23,0.08,0.43,0.25,0.59c0.17,0.16,0.37,0.24,0.6,0.24c0.24,0,0.44-0.08,0.61-0.24c0.17-0.16,0.25-0.35,0.25-0.59
	V1.74c0-0.24-0.08-0.44-0.25-0.61c-0.17-0.17-0.37-0.25-0.61-0.25c-0.24,0-0.44,0.08-0.6,0.25s-0.25,0.37-0.25,0.61V3.79z"
      />
      <path
        className="icon-updraft_ray"
        d="M23.67,6.06c0,0.24,0.08,0.44,0.23,0.6c0.17,0.17,0.37,0.25,0.61,0.26s0.43-0.08,0.57-0.26l1.46-1.43
	c0.17-0.17,0.25-0.37,0.25-0.61c0-0.23-0.08-0.43-0.25-0.6c-0.17-0.17-0.37-0.25-0.61-0.25S25.49,3.84,25.33,4L23.9,5.47
	C23.75,5.63,23.67,5.82,23.67,6.06z"
      />
      <path
        className="icon-updraft_ray"
        d="M24.44,17.89c0,0.23,0.08,0.43,0.25,0.6l0.64,0.65c0.2,0.16,0.41,0.24,0.62,0.24
	...
	c-0.25,0-0.46,0.08-0.63,0.25C24.52,17.45,24.44,17.65,24.44,17.89z"
      />
      <path
        className="icon-updraft_ray"
        d="M25.95,11.57c0,0.24,0.08,0.43,0.25,0.59
