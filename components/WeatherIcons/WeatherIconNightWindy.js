...
const WeatherIconNightWindy = ({ elementClass, x, y, width, height, fill }) => {
  const classes = classNames({
    weatherIcon: true,
    'weatherIcon_night-windy': true,
...
WeatherIconNightWindy.propTypes = {
...
export default WeatherIconNightWindy;
