...
const WeatherIconNightCloudy = ({ elementClass, x, y, width, height }) => {
  const classes = classNames({
    weatherIcon: true,
    'weatherIcon_night-cloudy': true,
...
WeatherIconNightCloudy.propTypes = {
...
export default WeatherIconNightCloudy;
