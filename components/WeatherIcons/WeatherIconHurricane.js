...
const WeatherIconHurricane = ({ elementClass, x, y, width, height, fill }) => {
  const classes = classNames({
    weatherIcon: true,
    weatherIcon_hurricane: true,
...
WeatherIconHurricane.propTypes = {
...
export default WeatherIconHurricane;
