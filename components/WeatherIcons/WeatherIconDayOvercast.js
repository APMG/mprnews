...
const WeatherIconDayOvercast = ({ elementClass, x, y, width, height }) => {
  const classes = classNames({
    weatherIcon: true,
    'weatherIcon_day-overcast': true,
...
WeatherIconDayOvercast.propTypes = {
...
export default WeatherIconDayOvercast;
