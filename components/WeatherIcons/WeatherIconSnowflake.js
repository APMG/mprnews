...
const WeatherIconSnowflake = ({ elementClass, x, y, width, height, fill }) => {
  const classes = classNames({
    weatherIcon: true,
    weatherIcon_snowflake: true,
...
WeatherIconSnowflake.propTypes = {
...
export default WeatherIconSnowflake;
